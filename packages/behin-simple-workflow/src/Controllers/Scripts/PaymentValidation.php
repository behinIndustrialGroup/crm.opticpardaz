...
class PaymentValidation extends Controller
{
    ...
    public function execute()
    {
        ...
        {
            if(!$case->getVariable('payment_method')){
                return "روش پرداخت را وارد کنید";
            }
            if(!$case->getVariable('payment_receipt')){
                return "رسید پرداخت را وارد کنید";
            }
            if(!$case->getVariable('payment_date')){
                return "تاریخ پرداخت را وارد کنید";
            }
            if(!$case->getVariable('payment_amount')){
                return "هزینه دریافت شده را وارد کنید";
            }
