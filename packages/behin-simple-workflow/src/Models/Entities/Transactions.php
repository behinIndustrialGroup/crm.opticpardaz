...
{ 
    ...
    protected $fillable = ['date', 'transaction_type', 'amount', 'description', 'category', 'case_id', 'payment_method', 'counterparty', 'document_number', 'register_user_id', 'status', 'notes', 'created_by', 'updated_by', 'contributers', ]; 
